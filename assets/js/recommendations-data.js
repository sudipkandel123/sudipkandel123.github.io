...
const RECOMMENDATIONS = [
  {
    ...
    "featuredQuote": "He combined strong ML/model development skills with a genuinely collaborative approach to quality - bringing QA in early.",
    "message": "I worked with Sudip for several months as a QA engineer while he served as an AI engineer on our team. He combined strong ML/model development skills with a genuinely collaborative approach to quality bringing QA in early, thinking through edge cases with us, and staying open to feedback rather than treating testing as an afterthought. He was reliable, easy to work with, and someone I'd gladly work with again."
  },
  {
    "id": "volha-nestserava",
  ...
  },
  {
    ...
    "company": "AWTG",
    "date": "June 2026",
    "linkedinUrl": "https://www.linkedin.com/in/sudipkandel123/details/recommendations/",
    "avatarInitials": "DN",
    "accent": "#10b981",
    "featured": false,
    "filters": [
    ...
    "featuredQuote": "Sudip brings valuable insight to all things AI and ML. His contributions helped improve our AI knowledge across the organisation.",
    "message": "Sudip brings valuable insight to all things AI and ML. His contributions helped improve our AI knowledge across the organisation. He’s proactive and loves to get involved with the team to support in both knowledge and expertise. He’s also good vibes and fun to have around which makes working with him easier. Highly recommend."
  },
  {
    "id": "vikas-gurung",
    "name": "Vikas Gurung",
  ...
  },
  {
    ...
    "featuredQuote": "He has a rare combination: a deep, current understanding of GenAI and agentic AI, paired with a relentless focus on outcomes.",
    "message": "I've worked with Sudip on a couple of AI projects, and I'm genuinely inspired by both his technical depth and the way he thinks. He has a rare combination: a deep, current understanding of GenAI and agentic AI, paired with a relentless focus on outcomes. He cares less about elegant theory and more about what actually delivers value, and that mindset shows in everything he ships. If you get a chance to work with Sudip, take it! Strongest possible recommendation!"
  },
  {
    "id": "oleg-koltun",
    "name": "Oleg Koltun",
  ...
  },
  {
    ...
    "featuredQuote": "His ML expertise plays a key role in the foundation the whole platform is built on - and the reliability is a direct result of his engineering work.",
  ...
  },
  {
    ...
    "featuredQuote": "Sudip is a standout AI/ML Engineer who consistently turns complex data challenges into scalable solutions.",
    "message": "Sudip is a standout AI/ML Engineer who consistently turns complex data challenges into scalable solutions. While reporting to me, he demonstrated deep technical intuition and a relentless drive to ship high-performing models. He is a sharp problem-solver and would be a significant asset to any engineering team."
  },
  {
    "id": "erkan-berk",
    "name": "Erkan Berk",
    ...
    "featuredQuote": "He’s an energetic, highly motivated AI/ML developer who takes real initiative, takes ownership, communicates well, and reliably delivers.",
    "message": "As Sudip's Manager, I can confidently say he’s an energetic, highly motivated AI/ML developer who takes real initiative. He’s consistently positive, always smiling, and brings great momentum to the team. Sudip takes ownership, communicates well, and reliably delivers. I’d strongly recommend him."
  },
  {
    "id": "mohanapriya-jagannathan",
    ...
    "featuredQuote": "He consistently demonstrated a strong willingness to upskill and adapt, and he always ensured that timelines were met with diligence.",
  ...
  },
  {
    ...
    "featuredQuote": "His expertise in AI/ML, particularly in GenAI - working with LLMs using RAG and fine-tuning - was impressive.",
    "message": "Sudip Kandel was my reportee for a year during a vertical realignment at Accenture, and he quickly became an essential part of our team. His ability to adapt to new challenges and learn rapidly made him a valuable contributor from the start. His expertise in AI/ML, particularly in GenAI-working with LLMs using RAG and fine-tuning-was impressive. Additionally, his strong grasp of machine learning techniques, such as clustering algorithms for anomaly detection and root cause analysis, played a crucial role in delivering impactful solutions. Beyond his technical skills, Sudip’s strong communication and collaboration abilities made him an excellent team player. His approachability and problem-solving mindset added to his effectiveness in both individual and team-based projects. I highly recommend Sudip for any AI/ML-related role-his combination of technical expertise and soft skills would be a great asset to any team."
  },
  {
    "id": "khusboo-agarwal",
  ...
  },
  {
    ...
    "featuredQuote": "I was consistently impressed by his exceptional technical skills, focused mindset, and analytical skills.",
    "message": "I had the pleasure of collaborating with Sudip on POC work and followed by a project, and I was consistently impressed by his exceptional technical skills, focused mindset, and analytical skills. One aspect that impressed me the thirst he has for gaining knowledge in Python then. I want to highlight his true dedication to work under pressure, proactive mindset for new challenges, surpassing goals with determination and contributed effectively to achieve shared objectives."
  },
  {
    "id": "anjana-balagopalan",
  ...
  },
  {
    ...
    "featuredQuote": "His ability to quickly grasp and implement new technologies stood out. His focus on client insights and a solution-driven approach made a significant impact.",
    "message": "I had the pleasure of working with Sudip Kandel on multiple projects at Accenture, ranging from internal accelerators to AI-based applications. He was an integral part of our team, demonstrating exceptional technical expertise and a strong commitment to continuous learning. During his tenure as an AI Engineer at Accenture, I closely collaborated with him on various initiatives, where his ability to quickly grasp and implement new technologies stood out. His focus on client insights and solution-driven approach made a significant impact on our projects. Sudip’s active involvement in multiple AI/ML projects, especially in the GenAI space, reflects his deep passion for innovation and problem-solving. I highly recommend him for any AI/ML-related roles, as he brings not only technical excellence but also a proactive mindset that drives meaningful results."
  },
  {
    "id": "mahitha-anumukonda",
  ...
  },
  {
    ...
    "featuredQuote": "He has a knack for simplifying complex challenges and applying innovative techniques to achieve the best outcomes.",
    "message": "I had the privilege of working with Sudip Kandel on various projects, and it was an incredibly valuable experience. His expertise in AI and machine learning, especially in handling time series data, played a key role in generating impactful insights. Sudip’s strong analytical mindset, along with his problem-solving abilities, made a noticeable impact on our work. He has a knack for simplifying complex challenges and applying innovative techniques to achieve the best outcomes. His curiosity and drive to explore new methodologies continuously led to valuable improvements. I highly recommend him for any AI/ML role, as his technical expertise, commitment, and teamwork make him an invaluable asset to any organization."
  },
  {
    "id": "rabindra-neupane",
    ...
    "featured": false,
    "filters": [],
    "featuredQuote": "His proactive approach to learning and applying new technologies ensured seamless integration and enhanced system performance.",
    "message": "I had the privilege of working with Sudip Kandel on a GenAI-driven RAG-based product, where his technical expertise and adaptability were key to the project's success. Sudip demonstrated an impressive ability to quickly grasp complex concepts in AI, particularly in areas like similarity search, text-to-speech, speech-to-text models, and vector databases. His proactive approach to learning and applying new technologies ensured seamless integration and enhanced system performance. I highly recommend Sudip for any AI or machine learning role, as his skills and proactive mindset make him a valuable asset to any team."
  },
  {
    "id": "tamilselvi-uthandi",
    ...
    "featuredQuote": "The very next day, he presented a fully constructed data model diagram with intricate table structures.",
    "message": "I was pleased to work with Sudip on an insurance project for a customer in the UK. As a senior team member, I closely collaborated with him and was truly impressed by his ability to grasp complex requirements quickly and deliver solutions independently. One standout moment was when I discussed the project structure and requirements with him-the very next day, he presented a fully constructed data model diagram with intricate table structures. This showcased his exceptional learning agility, analytical thinking, and problem-solving skills. I highly recommend Sudip for any data-driven, analytical, or technical roles. He would be a valuable addition to any organization!"
  },
  {
    "id": "pravin-pathak",
    "name": "Pravin Pathak",
  ...
  },
  {
    ...
    "featuredQuote": "His ability to implement and fine-tune models for business needs was impressive, and he effectively communicated complex concepts to both technical and non-technical teams.",
    "message": "In my experience working with Sudip at EXL, he consistently demonstrated strong expertise in Machine Learning and AI. His ability to implement and fine-tune models for business needs was impressive, and he effectively communicated complex concepts to both technical and non-technical teams. Sudip's problem-solving skills and collaboration made him a valuable team member, and I highly recommend him for any role in AI/ML"
  },
  {
    "id": "arunima-sarkar",
    "name": "Arunima Sarkar",
    ...
    "featuredQuote": "He has the ability to understand complex business problems, dedication to solve it with his technical expertise and deliver quality work on time.",
    "message": "I have worked with Sudip for a critical project over a very tight schedule. He has the ability to understand complex business problems, dedication to solve it with his technical expertise and deliver quality work on time. He is genuinely recommended for any data science related project in future."
  },
  {
    "id": "nishant-sharma",
    "name": "Nishant Sharma",
    ...
    "featuredQuote": "He personifies what a full stack data scientist looks like - from development to deployment, failing fast, and landing holistic solutions.",
  ...
  },
  {
    ...
    "featuredQuote": "He quickly adapts to new technologies, leads with insight, and is approachable.",
    "message": "Working with Sudip Kandel at Accenture has been a great experience. He quickly adapts to new technologies, leads with insight, and is approachable. His strong technical skills and leadership skills were commendable. I highly recommend him for any AI or data science roles."
  },
  {
    "id": "rushali-raina",
    "name": "Rushali Raina",
    ...
    "featuredQuote": "Sudip consistently demonstrated quick adaptability to changing client requests and needs.",
    "message": "I had the pleasure of working with Sudip Kandel on several data science and NLP-based client projects, particularly in the retail sector where we implemented time series forecasting and natural language summarization techniques. Sudip consistently demonstrated quick adaptability to changing client requests and needs. Beyond his technical expertise, Sudip exhibited strong leadership qualities and a robust approach to problem-solving. His critical thinking and problem-solving abilities were impressive, and his excellent communication skills made him a valuable asset to our team. Sudip's commitment to delivering high-quality work and his ability to navigate complex challenges are truly commendable. I highly recommend him for any data science or AI-driven projects."
  },
  {
    "id": "ambreesh-pothuraju",
    ...
    "featuredQuote": "He played a key role in a data analytic project, with strong experience in data modeling, Python, and machine learning.",
    "message": "I recommend sudip he played a key role in data analytic project. He has good experience in data modeling, python programming and machine learning. I strongly recommend sudip for data analytic projects. Hope this will help you in on going project. All the best for your future."
  },
  {
    "id": "prathippa-devi",
    "name": "Prathippa Devi",
  ...
  },
  {
    ...
    "featuredQuote": "Despite being a fresher, Sudip took on the challenge with enthusiasm and dedication, and his contributions created significant value for the client.",
    "message": "I had the pleasure of working with Sudip during his tenure at EXL Services, and I am thoroughly impressed by his contributions and achievements. As a quick learner with a keen interest in technology, Sudip quickly excelled and delivered outstanding results. His ability to learn and adapt to new technologies was remarkable. Despite being a fresher, Sudip took on the challenge with enthusiasm and dedication. He successfully collaborated with the team and demonstrated great leadership qualities. His professionalism and commitment were instrumental in securing and delivering a critical client project. Sudip's contributions created significant value for one of our clients. His innovative approach and technical expertise ensured the project's success, leaving a lasting positive impact. I highly recommend Sudip for any future endeavors. His combination of technical skills, leadership qualities, and professionalism makes him an invaluable asset to any team."
  }
];
